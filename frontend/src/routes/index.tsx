...
function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-paper-100">
      ...
      <header className="sticky top-0 z-40 bg-paper-100">
          ...
          >
            <div className="relative">
              ...
              <Input
                ...
                className="w-full h-12 rounded-full border border-ink-200 bg-white py-2 pl-12 pr-4 text-ink-900 placeholder:text-ink-400 transition focus:border-warm-500 focus:outline-none focus:ring-2 focus:ring-warm-500/20"
              />
            </div>
          </SearchField>
        </div>
      ...
      {/* FAB */}
      <Button
        onPress={() => navigate({ to: isAuthenticated ? '/recipes/new' : '/login' })}
